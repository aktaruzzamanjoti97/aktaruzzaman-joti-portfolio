								...
								<div className='grid grid-cols-1 lg:grid-cols-2'>
									<div className='p-6 mr-2 mt-8   sm:rounded-lg'>
										...
										<p className='text-normal text-md font-normal text-gray-400 dark:text-gray-400 mt-2'>
											...
											suggestions or just to say hi. I am always open
											to new ideas and collaborations. It can be
											anything like collaborating on good projects or
											startups or freelancing or gaming or anything
											else.
										</p>
										...
										<form className='p-6  flex flex-col justify-center'>
											...
											<div className='flex flex-col mt-2'>
												...
												<textarea
													...
													className='w-100 mt-2 py-3 px-3 rounded-lg bg-white  border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none'></textarea>
											</div>
												...
												<button
													...
													onClick={() => {
														if (email === '') {
															...
															setError(
																'Please enter M. Aktaruzzaman Joti.'
															);
														} else {
															setError('');
															setEmail('');
										...
										<div className=' flex  w-4/3 items-center justify-center'>
											<div className='text-center justify-center text-gray-300 font-medium text-sm'>
												<div className=' text-left text-lg pb-3'>
													Thank you for your message. <br /> Will
						...
						<div className=' '>
							<div className='overflow-hidden'>
								<div className='p-3 '>
									...
									<p className='text-normal text-md font-normal text-gray-400 dark:text-gray-400 mt-2'>
										You can contact me with any questions, suggestions
										or just to say hi. I am always open to new ideas
										and collaborations. It can be anything like
										collaborating on good projects or startups or
                         ...
                         bg-white  border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none'
										...
										<div className=' mt-2'>
											...
											<textarea
												...
												className='w-full mt-2 py-3 px-3 rounded-lg bg-white  border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none'></textarea>
										</div>
											...
											<button
												...
												onClick={() => {
													if (email === '') {
														...
														setError('Please enter M. Aktaruzzaman Joti.');
													} else {
														setError('');
														setEmail('');
														setMessage('');
                         ...
                         hover:bg-indigo-500 transition ease-in-out duration-300'>
									...
									<div className=' flex p-2 pt-5  pb-20 w-full items-center justify-center'>
										<div className='text-center justify-center text-gray-300 font-medium text-sm'>
											<div className=' text-left text-lg pb-3'>
												Thank you for your message. <br /> Will get
